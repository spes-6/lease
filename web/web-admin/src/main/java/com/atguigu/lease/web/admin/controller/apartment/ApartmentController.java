...
public class ApartmentController {
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        LambdaQueryWrapper<ApartmentInfo> apartmentInfoWrapper = new LambdaQueryWrapper<>();
        apartmentInfoWrapper.eq(ApartmentInfo::getDistrictId,id);
        List<ApartmentInfo> list = service.list(apartmentInfoWrapper);
