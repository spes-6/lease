...
//明文转密文
    ...
    public Result<Boolean> isUsernameExists(@RequestParam String username) {
        LambdaQueryWrapper<SystemUser> userInfoLambdaQueryWrapper = new LambdaQueryWrapper<>();
        userInfoLambdaQueryWrapper.eq(SystemUser::getUsername, username);
        long count = service.count(userInfoLambdaQueryWrapper);
    ...
    public Result updateStatusByUserId(@RequestParam Long id, @RequestParam BaseStatus status) {
        ...
        systemUserLambdaUpdateWrapper.eq(SystemUser::getId, id).set(SystemUser::getStatus, status);
